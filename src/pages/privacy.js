...
const PrivacyPage = ({ children }) => {
    ...
    const siteUrl = siteUrl || site.siteMetadata.siteUrl
    const author  = author || site.siteMetadata.author
    return (
        <Layout>
        <h2>Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is {author} policy to respect
